    ...
    public partial class InventorBuildRibbon
    {
        ...
        private List<CommandItem> GetCommands()
        {
            return new List<CommandItem>
            {
                ...
                new CommandItem(Commands.RunMacro, "Full path to the SOLIDWORKS macro file (.swp or .bas)", ConstantStrings.ParentText, "Name of the procedure to run (default: Main)", applicationType: ApplicationTypeEnum.Solidworks),
